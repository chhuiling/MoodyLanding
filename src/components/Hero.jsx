    ...
    return (
        <section className='absolute top-30 flex justify-center w-5/6 h-1/2 gap-8'>
            ...
            <div className='h-full relative flex flex-col justify-center'>
                ...
                <button className='py-2 border rounded-2xl w-1/2 mt-8 hover:cursor-pointer hover:bg-[rgba(255,255,255,0.2)] transition-all ease-in-out duration-700'>download now</button>
            </div>
        </section>
    )
}